...
<body>
<form action="addprocessed" style="border:1px solid #ccc" method="post">
  <div class="container">
  <center>
    ...
    <input type="text" placeholder="Enter Quantity" name="pquantity" required>

    <label for="psw"><b>Enter Unit</b></label>
    <input type="text" placeholder="Enter Unit(pic,kg,gm)" name="punit" required>
    
    <label for="psw"><b>Enter Cost per Unit</b></label>
    <input type="text" placeholder="Enter Cost" name="pcost" required>

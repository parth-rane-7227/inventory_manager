...
<%@page import="com.r3sys.modal.IssueProcessedItem"%>
...
@media screen and (max-width: 300px) {
  ...
  <body><center>
  <br>
  <h2><strong><em>View Issue Processed Item</em></strong></h2></center>
  <hr>
    <table class="table">
  ...
  for(IssueProcessedItem rm : issueProcessedItem)
  {
  %>
  <tbody>
    <tr>
      <th scope="row"><%= rm.getIpid()%></th>
      <td><%= rm.getPid()%></td>
      <td><%= rm.getPname()%></td>
      <td><%= rm.getIpname()%></td>
      <td><%= rm.getIpquantity()%></td>
    </tr>
  </tbody>
  <%} %>
</table>
